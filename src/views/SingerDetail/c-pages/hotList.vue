<template>
  <div class="list">
    ...
    <div class="list-table">
      ...
      <template v-for="(item, index) in listData.slice(0, 10)" :key="item.id">
        <div class="item">
...
export default {
  ...
  methods: {
    ...
    getPageData(id) {
      ...
      requestSimiSinger(id).then((res) => {
        this.simiData = res.artists;
      });
      requestSingerAlbum(id).then((res) => {
